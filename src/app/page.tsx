          ...
          >
            <span className="inline-flex h-5 w-5 items-center justify-center">
              <svg viewBox="-3 0 262 262" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" aria-hidden>
                ...
                <path d="M130.55 261.1c35.248 0 64.839-11.605 86.453-31.622л-41.196-31.913c-11.024 7.688-25.82 13.055-45.257 13.055-34.523 0-63.824-22.773-74.269-54.25л-1.531.13-40.298 31.187-.527 1.465C35.393 231.798 79.49 261.1 130.55 261.1" fill="#34A853"/>
